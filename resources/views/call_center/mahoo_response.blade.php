    ...
    <main id="main">
        ...
        <section id="contact" class="contact" style="position:relative;top:100px;margin-bottom:100px;">
            <div class="container">
                ...
                <div class="section-title" data-aos="zoom-out" style="text-align:center !important;">
                    <p style="font-size: 20px;">Poll Five</p>
                </div>
                ...
                <div class="container">
                    @foreach($polling_stations as $polling_station)
                        <div class="section-title" data-aos="zoom-out" style="text-align:center !important;">
                            <p style="font-size: 20px;text-align: left;">{{$polling_station->polling_center}}</p>
                        </div>
                            ...
                            <div class="col-md-6">
                                <table class="table table-responsive">
                                    ...
                                    @foreach($polling_station_results as $index => $result)
                                        @if($result->polling_center == $polling_station->polling_center)
                                            <tr>
                                                <td>{{$counter++}}</td>
                                                <td>{{$result->candidate}}</td>
                                                <td>{{$result->votes}}</td>
                                                @foreach($polling_station_total as $total)
                                                    @if($total->polling_center == $polling_station->polling_center)
