            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-12 mt-5 mt-lg-0" data-aos="fade-left">
                        ...
                        <form action="{{url('save-pledge')}}" method="post" role="form" class="php-email-form">
                            @csrf
                            <div class="row">
                                ...
                                <div id="main_area">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label class="form-group">Pledges</label>
                                            <select class="form-control" name="candidate"
                                                ...
                                                <option value="Split in favour of Ruto">Split in favour of Ruto</option>
                                                <option value="Split in Favour of K'angata">Split in Favour of K'angata</option>
