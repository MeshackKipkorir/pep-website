                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control" name="profession" 
                                    placeholder="Profession" data-msg="profession is required" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control" name="current_party"
                                    placeholder="Current Party" data-msg="Current Party is required" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="mb-3">
